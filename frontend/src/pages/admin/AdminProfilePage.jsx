...
const api = {
  ...
  updateProfile: (data) =>
    axios.put("http://localhost:8000/api/me/update", data),
  changePassword: (data) =>
    axios.post("http://localhost:8000/api/me/change-password", data),
};
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 text-slate-800">
      ...
      <main className="flex-1 w-full min-w-0">
          ...
          <div className="mb-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => navigate(-1)}
                  className="flex items-center gap-2 text-sm bg-white border border-slate-300 rounded-md px-3 py-2 hover:bg-slate-50"
                >
                ...
                {isOwnProfile && (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 text-sm bg-indigo-600 text-white rounded-md px-3 py-2 hover:bg-indigo-700"
                    >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                        ...
                        <InfoRow
                          icon={<Users size={14} />}
                          label="Giới tính"
                          value={translateGender(user.gender)}
                        />
                      </div>
                      <div className="mt-6 pt-6 border-t border-slate-200">
                        ...
                        <p className="text-sm text-slate-600 italic">
                          {user.about_me || "Chưa có giới thiệu."}
                        </p>
                      </div>
                    </div>
                  )}
        ...
        {isOwnProfile && isPasswordModalOpen && (
          <ChangePasswordModal closeModal={() => setPasswordModalOpen(false)} />
        )}
      </main>
    </div>
  );
